...
import { HttpXsrfTokenExtractorDefault } from '../service/http-xsrf-token-extractor.service';
...
@NgModule({
    ...
    providers: [
        CookieService,
        { provide: HttpXsrfTokenExtractor, useClass: HttpXsrfTokenExtractorDefault }]
})
